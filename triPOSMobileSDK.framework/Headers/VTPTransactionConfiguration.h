...
///
/// This property gets or sets if cashback is allowed.  This value cannot be set to YES if quickChipEnabled is YES.
///
...
///
/// This property enables or disables Quick Chip.  Setting this property to YES will automatically set isCashbackAllowed to NO.
///
