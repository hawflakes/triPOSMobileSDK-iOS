...
///
@property (retain, nonatomic, readonly) NSDate *TransactionDateTimeBeginEx;
...
///
@property (retain, nonatomic, readonly) NSDate *TransactionDateTimeEndEx;
...
///
@property (retain, nonatomic, readonly) NSString *TransactionID;
